...
const Navbar = ({ setShowLogin, contactRef }) => {
  ...
  return (
    <div className='px-4 py-6 flex justify-between items-center relative z-[999]'>

      {/* Logo */}
      <Link to='/'>
        <img src="logo3.png" alt="" className='w-24 sm:hidden hover:scale-105 transition-transform duration-200 ' />
        <img src="logo2.png" className='hidden sm:block sm:w-60 hover:scale-105 transition-transform duration-200' alt="" />
      </Link>
      ...
      <div className='flex sm:items-center sm:gap-8'>
        ...
        <div className='relative md:ml-6'>
          <Link to='/cart'>
            <img className='w-9 hover:scale-110 transition-transform duration-200' src="bag.png" alt="" />
          </Link>
        ...
        {!token ? (
          <button
            className='bg-red-500 text-white text-base border py-2 px-7 border-solid rounded-3xl cursor-pointer hover:bg-red-400 ml-4'
            onClick={() => setShowLogin(true)}
          >
            sign in
          </button>
        ) : (
          <div className='relative group' id='profile'>
            ...
            <ul className='absolute hidden group-hover:flex flex-col gap-2.5 pb-3 pt-3 pl-6 pr-6 bg-white rounded border border-red-500 border-solid outline outline-white list-none right-0 z-10' id='profile-dropdown'>
              <Link to="/myorders">
                <li className='flex cursor-pointer gap-2 items-center'>
              ...
              <li onClick={logout} className='flex cursor-pointer gap-2 items-center'>
