...
const Cart = () => {
  ...
  <button onClick={()=>navigate("/order")} className='border-none text-white bg-red-600 w-56 pt-3 pb-3 pr-0 pl-0 rounded cursor-pointer hover:bg-red-500'>PROCEED TO CHRCKOUT</button>
        </div>
